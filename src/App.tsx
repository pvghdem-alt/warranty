    ...
    <div className="min-h-screen bg-[#F8FAFC] text-slate-800 font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-0">
          <div className="flex flex-wrap md:flex-nowrap justify-between items-center md:h-16 gap-3 md:gap-4">
            
            {/* Logo Section */}
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 shrink-0 bg-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20">
            ...
            {/* View Switcher - order last on mobile (new row), normal on desktop */}
            <div className="order-last md:order-none w-full md:w-auto flex justify-center mt-2 md:mt-0">
              <div className="flex items-center bg-slate-100 p-1 rounded-xl w-full sm:w-auto justify-between md:justify-center flex-wrap sm:flex-nowrap">
                <button
                  onClick={() => setActiveView('warranties')}
                  className={`flex-1 sm:flex-none text-center whitespace-nowrap px-3 py-1.5 rounded-lg text-sm font-bold transition-all ${
                ...
                <button
                  ...
                  className={`flex-1 sm:flex-none text-center whitespace-nowrap relative px-3 py-1.5 rounded-lg text-sm font-bold transition-all ${
                    activeView === 'issues' 
                      ? 'bg-white text-blue-600 shadow-sm' 
                      : 'text-slate-500 hover:text-slate-700'
                  }`}
                >
                  工單管理
                  {unreadIssuesCount > 0 && (
                    <span className="absolute top-1 right-2 sm:-top-1 sm:-right-1 flex h-4 w-4 items-center justify-center rounded-full bg-red-500 text-[9px] font-bold text-white shadow-sm ring-2 ring-slate-100">
            ...
            <div className="flex items-center justify-end gap-2 sm:gap-3 shrink-0">
              ...
              <motion.button
                ...
                className="bg-white border border-slate-200 text-slate-500 p-2 rounded-xl text-sm font-bold flex items-center justify-center transition-all hover:border-slate-300 w-9 h-9 sm:w-auto sm:h-auto sm:px-2"
                title="設定 API 金鑰"
              >
              ...
              <motion.button
                ...
                className="bg-red-50 hover:bg-red-100 text-red-600 p-2 rounded-xl text-sm font-bold flex items-center justify-center transition-all w-9 h-9 sm:w-auto sm:h-auto sm:px-2"
                title="登出系統"
              >
              ...
              <motion.button
                ...
                className="bg-indigo-600 hover:bg-indigo-700 text-white p-2 sm:px-3 sm:py-2 rounded-xl text-sm font-bold flex items-center justify-center gap-2 shadow-lg shadow-indigo-500/20 transition-all w-9 h-9 sm:w-auto sm:h-auto"
                title="AI 匯入"
              >
              ...
              {!showForm && (
                <motion.button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white p-2 sm:px-3 sm:py-2 rounded-xl text-sm font-bold flex items-center justify-center gap-2 shadow-lg shadow-blue-500/20 transition-all w-9 h-9 sm:w-auto sm:h-auto"
                  title="新增案件"
                >
